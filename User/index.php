    ...
    <header id="#topheader">
        <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark shadow">
            <div class="container-fluid">
                <a class="navbar-brand h1 fw-bold" href="#toppage"><img src="../Images/logo.svg" alt="logo" class="img-fluid" height="70px" width="70px">GHUMFHIR</a>
                <button 
    ...
    <section id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <span class="carousel-caption">Find new adventures with GhumFhir 1 </span>
            ...
            <img class="d-block w-100" src="../Images/banner1.jpg" alt="First slide" height="600px" style="object-fit:cover;">
                <div class="carousel-caption d-none d-md-block">
                <span class="carousel-caption">Find new adventures with Ghumfhir </span>
                    <div class="slider-btn">
                        <a href="#tourpackages" class="clickableBtn btn banner-caption">Start Now</a>
                    </div>
                </div>
            ...
            <div class="row text-white d-flex justify-content-between">
                ...
                <div class="col-lg-3 col-12">
                    ...
                    <div class="d-flex flex-column flex-wrap">
                        ...
                        <a href="#ourteam" class=" text-white pb-1">Our Team</a>
