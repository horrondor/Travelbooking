...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark shadow p-md-3">
            ...
            <a class="navbar-brand h1 fw-bold" href="./index.php#toppage"><img src="../Images/logo.svg" alt="logo" class="img-fluid" height="70px" width="70px" />GHUMFHIR</a>
    ...
    <div id="user-review" class="container shadow p-4 mb-5">
        ...
        <div class="review-card">
            <div class="card-header">
                <h3 class="mt-2 mb-2">User Reviews</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6 text-center">
                        ...
                        <span id="total_review"><h4>Total: <?= $total_reviews; ?>  Reviews</h4></span>
                    </div>
                    <!-- <div class="col-sm-4">
                        <p>
        ...
        <div class="container">
            <div class="row text-white d-flex justify-content-between">
                <div class="col-lg-5 col-12">
                    <h4 class="text-white">GhumFhir</h4>
                ...
                <div class="col-lg-3 col-12">
                    ...
                    <div class="d-flex flex-column flex-wrap">
                        ...
                        <a href="./index.php#ourteam" class=" text-white pb-1">Our Team</a>
                        <a href="./index.php#tourpackages" class=" text-white pb-1">Tour Packages</a>
                        <!-- <a href="./index.php#privacypolicy" class=" text-white pb-1">Privacy Policy</a> -->
                        <a href="./index.php#contactus" class=" text-white pb-1">Contact Us</a>
    ...
    <div class="copyright text-center bg-dark text-white py-2">
        <p class="text-white">&copy;Copyrights @2024. All rights reserved by <a href="#toppage" class="color-secondary">GhumFhir</a> </p>
    </div>
